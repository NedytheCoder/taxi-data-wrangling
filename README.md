...
This data wrangling project analyzes NYC taxi trip data, joins it with daily weather data, detects anomalous trips using a robust z-score method, and generates a deterministic dataset fingerprint.
